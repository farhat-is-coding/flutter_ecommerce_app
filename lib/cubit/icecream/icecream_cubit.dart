...
class IcecreamCubit extends Cubit<IcecreamState> {
  IcecreamCubit() : super(IcecreamLoaded([
    IceCream(
  ...
  void getIceCreamData(FilterCubit filterCubit) {
    ...
    // log('flavor is $flavor');
    // double price =
    //     filterCubit.price == "Prices" ? 0 : double.parse(filterCubit.price);
    // double rating =
    //     filterCubit.rating == "Ratings" ? 0 : double.parse(filterCubit.rating);
